...
function Textarea({
  ...
  return (
    <TextInput
      className={cn(
        "flex min-h-16 w-full flex-row rounded-md border border-input bg-background px-3 py-2 text-base text-foreground shadow-black/5 shadow-sm md:text-sm dark:bg-input/30",
        Platform.select({
